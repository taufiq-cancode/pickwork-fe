            ...
            <Container className="pt-4 pt-lg-0">
                <Row className="g-4 g-xl-6 align-items-center">
                    ...
                    <Col md={6}>
                        ...
                        <p className="mb-0">Need a help with something? Here are our most frequently asked
                            questions.</p>

                        <Col xs={10} className="mt-4">
                            <Form className="position-relative">
                                <Form.Control size='lg' className="bg-light ps-6" type="search"
                                              placeholder="Enter your keyword..."/>
                                <button
                                    className="btn bg-transparent px-3 py-0 position-absolute top-50 start-0 translate-middle-y"
                                    type="submit"><BsSearch className="fs-6"/></button>
                            </Form>
                        </Col>
                    </Col>
                    ...
                    <Col md={6}>
                        <svg viewBox="0 0 502.3 300.7">
                            ...
                            <path className="fill-mode opacity-9"
